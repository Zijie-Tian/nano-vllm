...
"""
    ...
    def evaluate(
        ...
        **eval_kwargs,
        ...
        result = evaluator(*tvm_arrays)
        gc.collect()
        return result

    def _get_dispatch_context(self, *args):
        dispatch_context = autotvm.apply_history_best(self.log_path)
    ...
    def codegen(
        ...
        **eval_kwargs,
        ...
        if self.remote_kwargs is not None:
            ...
            return func_impl, device

    def verify(self, *args, **kwargs):
        raise NotImplementedError

    def __call__(self, *args, **kwargs):
        return self.codegen(*args, **kwargs)