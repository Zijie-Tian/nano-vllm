...
This project may run with multiple Codex/Claude instances, each needing a dedicated GPU.
...
Codex: "Which GPU should I use for this benchmark?"
User: "Use GPU 2"
Codex: Runs `CUDA_VISIBLE_DEVICES=2 ./scripts/run_ruler.sh ...`
```

**Wrong:**
```
User: "Run the RULER benchmark"
Codex: Runs `./scripts/run_ruler.sh ...`  # NO! Missing GPU specification!
```
