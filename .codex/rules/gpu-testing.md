...
This project runs with multiple Codex instances on different worktrees, each needing a dedicated GPU.
...
Codex: "Which GPU should I use for this test?"
User: "Use GPU 2"
Codex: Runs `CUDA_VISIBLE_DEVICES=2 python tests/test_needle.py ...`
```

**Wrong:**
```
User: "Run the needle test"
Codex: Runs `python tests/test_needle.py ...`  # NO! Missing GPU specification!
```
