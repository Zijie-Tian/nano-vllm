...
## Purpose
减少 Codex runtime 加载的 token 量，通过将详细文档分离到 `docs/` 目录，仅在需要时按需加载。
...
1. **Token 节省**: `AGENTS.md` 保持精简，减少每次会话加载的 token
