---
description: Documentation management policy for GEMINI.md and CLAUDE.md content organization
---

# Documentation Management

## GEMINI.md / CLAUDE.md Content Policy

**GEMINI.md 和 CLAUDE.md should only contain operational requirements:**
...
├── BLASST_RULER_INTEGRATION.md # BLASST 集成
├── <new_topic>_guide.md      # New technical topic
```

### Step 3: Update BOTH Documentation Indexes

**必须同时更新 GEMINI.md 和 CLAUDE.md 的文档引用表：**
...
If GEMINI.md or CLAUDE.md grows too large (> 200 lines), refactor:
...
4. Keep only operational essentials in config files
