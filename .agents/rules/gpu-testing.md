---
description: GPU type detection, card assignment rules, and memory estimation for testing
---
...
This project may run with multiple agent instances, each needing a dedicated GPU.
